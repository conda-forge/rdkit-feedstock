...
#EXTRA_CMAKE_FLAGS=" -D Python_NumPy_INCLUDE_DIR=${HOST_NUMPY_INCLUDE_DIR} -D Python_INCLUDE_DIR=${HOST_PYTHON_INCLUDE_DIR}"
EXTRA_CMAKE_FLAGS=" -D Python_NumPy_INCLUDE_DIR=${HOST_NUMPY_INCLUDE_DIR} -D Python_INCLUDE_DIR=${HOST_PYTHON_INCLUDE_DIR} -D Python3_NumPy_INCLUDE_DIR=${HOST_NUMPY_INCLUDE_DIR} -D Python3_INCLUDE_DIR=${HOST_PYTHON_INCLUDE_DIR}"
